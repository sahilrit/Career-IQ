...
def build_search_state(query: JobSearchQuery) -> dict[str, Any]:
    ...
    state: dict[str, Any] = {"searchQuery": " ".join(terms)}
...
class HiringCafeProvider(JobProvider):
    ...
    def search(self, query: JobSearchQuery) -> JobSearchResult:
        ...
        for page in range(self._max_pages):
            html = self._transport.fetch_search_page(search_state=search_state, page=page)
